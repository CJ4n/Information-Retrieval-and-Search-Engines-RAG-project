...
% TODO write sth about datasets 
\begin{frame}{8.2 Neural document embeddings - hyperparams}
...
\begin{frame}
  \centering
  \includegraphics[width=0.9\textwidth]{embeddings_wiki_ir_parameter_heatmap1747308450.png}
\end{frame}
